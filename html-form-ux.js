...
var EMAIL_REGEXP_MINUS_COM = /^[A-Za-z0-9._%+-]+@[A-Za-z0-9-]+$/;
var EMAIL_REGEXP_MINUS_AT = /^[A-Za-z0-9._%+-]+$/;
...
function emailChange(e){
	if( e.keyCode != 8 && e.keyCode != 46 ) { /*backspace, delete */
		...
		if( EMAIL_REGEXP_MINUS_COM.test(this.value) ) {
			this.value = this.value + '.com';
			createSelection(this, length, length + 4);
		} else if( EMAIL_REGEXP_MINUS_AT.test(this.value) ) {
			this.value = this.value + '@';
			createSelection(this, length, length + 1);
		}
